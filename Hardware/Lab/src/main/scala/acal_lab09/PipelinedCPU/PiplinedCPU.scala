...
class PiplinedCPU(memAddrWidth: Int, memDataWidth: Int) extends Module {
    ...
    // forwarding signals
    datapath_ID.io.EXE_alu_out := datapath_EXE.io.EXE_alu_out
    datapath_ID.io.EXE_pc_plus_4 := datapath_EXE.io.EXE_pc_plus_4
    datapath_ID.io.MEM_alu_out := datapath_MEM.io.MEM_alu_out
    datapath_ID.io.MEM_pc_plus_4 := datapath_MEM.io.MEM_pc_plus_4
    datapath_ID.io.MEM_ld_data := datapath_MEM.io.MEM_ld_data
    datapath_ID.io.For_ASel := contorller.io.For_ASel
    datapath_ID.io.For_BSel := contorller.io.For_BSel

    
    // === EXE stage reg ==============================================================
    stage_EXE.io.Flush := contorller.io.Flush_DH || contorller.io.Flush_BH // To Be Modified
    ...
    stage_MEM.io.pc_plus_4_in := datapath_EXE.io.EXE_pc_plus_4
    ...
    datapath_MEM.io.MEM_pc_plus_4_in := stage_MEM.io.pc_plus_4
    ...
    stage_WB.io.pc_plus_4_in := datapath_MEM.io.MEM_pc_plus_4
    ...
    // WB Block Datapath
    datapath_WB.io.WB_pc_plus_4_in := stage_WB.io.pc_plus_4
    ...
    io.Flush := contorller.io.Flush_DH || contorller.io.Flush_BH
    ...
    io.WB_PC := Mux(stage_WB.io.pc_plus_4 > 0.U, stage_WB.io.pc_plus_4 - 4.U, stage_WB.io.pc_plus_4)
    ...
    io.MEM_opcode := stage_MEM.io.inst(6, 0)
    io.MEM_func3 := stage_MEM.io.inst(14, 12)
}